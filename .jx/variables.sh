...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-charts/jxboot-helmfile-resources/main/4'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jxboot-helmfile-resources:1.0.69'
