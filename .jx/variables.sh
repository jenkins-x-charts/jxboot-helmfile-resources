...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-charts/jxboot-helmfile-resources/main/94'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jxboot-helmfile-resources:1.1.325'
