...
export BUILD_NUMBER='386'
export DOCKERFILE_PATH='Dockerfile'
export DOCKER_REGISTRY='ghcr.io'
export DOCKER_REGISTRY_ORG='jenkins-x'
export DOMAIN='infra.jenkins-x.rocks'
export GIT_BRANCH='main'
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-charts/jxboot-helmfile-resources/main/386'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jxboot-helmfile-resources:1.2.76'
